...
import { loginUser } from "../components/Apis/login.services";
...
const AdminLoginPage = () => {
  ...
  const onSubmit = async (data) => {
    let sdk = new MkdSDK();
    //ToDo
    const result = await loginUser({ ...data, role: "admin" })
    if (result) {
      dispatch({ type: "LOGIN" });
      localStorage.setItem("jwt", result?.token);
      GlobalState.dispatch({ type: "SNACKBAR", payload: { message: "Logged In Successfully!" } })
